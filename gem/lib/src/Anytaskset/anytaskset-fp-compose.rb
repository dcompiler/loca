...
# example run:
#
# anytaskset-fp-compose.rb -m [max_threads] -l [lowest_pillar] -p [pillar_step] -f [sfp_file] -g [sharing_graph.sg] --group=1,2,4,5
#
# e.g. ./anyset-fp-compose.rb -m 8 -l 12 -p 2 -f fp.out -g sg.out --group=1,2,4,5
#
# Written by Hao Luo
#
#
